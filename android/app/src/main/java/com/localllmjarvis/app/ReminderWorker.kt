...
class ReminderWorker(
    ...
    override suspend fun doWork(): Result {
        ...
        reminders.forEach { reminder ->
            val due = reminder.remindAt?.let { parseInstantOrNull(it) } ?: return@forEach
    ...
    companion object {
        ...
        private fun showReminderNotification(context: Context, reminder: ReminderItem) {
            if (
